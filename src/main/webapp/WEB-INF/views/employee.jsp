	...
	<div id="employee_datagrid_tb">
		<div>
			...
			<c:if test="${myfn:checkPermission('com._520it.crm.web.controller.EmployeeController:update') }">
				<a id="employee_datagrid_edit" data-cmd="edit" class="easyui-linkbutton" data-options="iconCls:'icon-edit',plain:true">编辑</a>
			</c:if>
			<c:if test="${myfn:checkPermission('com._520it.crm.web.controller.EmployeeController:delete') }">
				<a id="employee_datagrid_del" data-cmd="del" class="easyui-linkbutton" data-options="iconCls:'icon-remove',plain:true">离职</a>
			</c:if>
	...
	<div id="employee_dialog" style="display:none;">
		<form id="employee_form" method="post">
			...
			<table align="center" style="margin-top: 15px; text-align: center">
				...
				<tr>
					<td>部门</td>
					<td><input class="easyui-combobox" name="dept.id" data-options="valueField:'id',textField:'name',url:'/dep_queryDept'"></td>
				</tr>
				<tr>
					<td>入职时间</td>
				...
				<tr>
					...
					<td><input id="emp_roles" class="easyui-combobox" data-options="valueField:'id',textField:'name',url:'/role_queryForEmp',multiple:true"></td>
				</tr>
			</table>
		</form>
	</div>
