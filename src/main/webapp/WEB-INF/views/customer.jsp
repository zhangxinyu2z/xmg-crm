	...
	<div id="customer_dialog">
		<form id="customer_form" method="post">
			...
			<table align="center" style="margin-top: 15px">
				...
				<tr>
					<td>职业</td>
					<td><input name="job" id="job" class="easyui-combobox" data-options="valueField:'name',textField:'name',editable:false,url:'/customer_queryDicItem?id=1'"></td>
				</tr>
				<tr>
					<td>收入水平</td>
					<td><input name="salarylevel" id="salarylevel" class="easyui-combobox" data-options="valueField:'name',textField:'name',editable:false,url:'/customer_queryDicItem?id=2'"></td>
				</tr>
				<tr>
					<td>客户来源</td>
					<td><input name="customersource" id="customersource" class="easyui-combobox" data-options="valueField:'name',textField:'name',editable:false,url:'/customer_queryDicItem?id=3'"></td>
				</tr>
			</table>
		</form>
		<!-- 新增员工对话框窗口  -->
	...
	<div id="transfer_dialog">
		<form id="transfer_form" method="post">
			...
			<table align="center" style="margin-top: 15px;">
				...
				<tr>
					<td><input name="newseller.id" class="easyui-combobox" data-options="valueField:'id',textField:'username',editable:false,url:'/queryEmployeeByRole'" /></td>
				</tr>
			</table>
		</form>
